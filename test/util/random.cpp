...
static Int n_choose_k(Int const n, Int const k) {
	...
	static constexpr Int factorial[21] = {1,
	                                      1,
	                                      2,
	                                      6,
	                                      24,
...
TEST(Random, UniformIntervalFloatUInt32Max) {
	test_uniform_interval<float>(constant_rng<UInt32>(MAX));
}
TEST(Random, UniformIntervalDoubleUInt32Max) {
	test_uniform_interval<double>(constant_rng<UInt32>(MAX));
}
...
TEST(Random, UniformIntervalDoubleUIntMax) {
	test_uniform_interval<double>(constant_rng<UInt>(MAX));
}