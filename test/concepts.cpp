...
static_assert(all_of<PerPopulationInit<per_population_init_const>, StatefulNeuron<per_population_init_const>,
                     Neuron<per_population_init_const>>);
...
static_assert(none_of<Neuron<both_stateless_and_stateful>, Neuron<both_inits>, Neuron<update_and_stateless>,
                      Neuron<update_and_stateful>, Neuron<update_and_per_neuron_init>,
                      Neuron<update_and_per_population_init>>);
