...
namespace spice {
template <class T>
concept StatelessNeuronWithoutParams = requires(float dt, snn_info& info) {
	{ T::update(dt, info) } -> std::same_as<bool>;
};

template <class T, class Params>
concept StatelessNeuronWithParams = requires(float dt, snn_info& info, Params params) {
...
template <class T>
concept StatefulNeuronWithoutParams = requires(T t, float dt, snn_info& info) {
...
template <class T, class Params>
concept StatefulNeuronWithParams = requires(T t, float dt, snn_info& info, Params params) {
	requires std::default_initializable<Params>;
	requires !StatelessNeuron<T>;
	requires std::default_initializable<T>;
	{ t.update(dt, info, params) } -> std::same_as<bool>;
...
concept StatelessSynapseWithoutParams = requires(Neur& n, snn_info& info) {
	requires StatefulNeuron<Neur>;
	T::deliver(n, info);
};

template <class T, class Neur, class Params>
concept StatelessSynapseWithParams = requires(Neur& n, snn_info& info, Params params) {
	requires std::default_initializable<Params>;
	requires StatefulNeuron<Neur>;
...
template <class T, class Neur>
concept StatefulSynapseWithoutParams = requires(T t, Neur& n, snn_info& info) {
	requires StatefulNeuron<Neur>;
...
template <class T, class Neur, class Params>
concept StatefulSynapseWithParams = requires(T t, Neur& n, snn_info& info, Params params) {
	requires std::default_initializable<Params>;
	requires StatefulNeuron<Neur>;
	requires !StatelessSynapse<T, Neur>;
	requires std::default_initializable<T>;
...
template <class T>
concept PlasticSynapse = requires(T t, float dt, bool pre, bool post, Int n, snn_info& info,
                                  util::any_t params) {
	requires(
